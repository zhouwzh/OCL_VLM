...
def load_model(model_name, pretrained=True):
    ...
    alg, data, model_spec = model_name.split("_")   #dino sfp resnext50
    ...
    checkpoint = hf_hub_download(repo_id="eminorhan/"+model_name, filename=model_name+".pth")  # eminorhan/dino_sfp_resnext50, dino_sfp_resnext50.pth
...
def build_dino_mugs(arch, patch_size):   # "resnext50_32x4d", None
    ...
    elif arch in torchvision_models.__dict__.keys():      # yes "resnext50_32x4d"
