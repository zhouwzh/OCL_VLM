...
def visualize(args,model,loss_fn):
    model.eval().cuda()
    frames1 = []
    frames2 = []
    for path in file_paths:
        ...
        if not args.visualize_ttt:
            ...
            feature, slotz, attent, attent2, recon = TTT(model, image, args.ttt_step, args.ttt_lr)
    ...
    # vutils.save_image(frames1, f"/scratch/wz3008/SlotAttn/MetaSlot/visualize_frames/{os.path.basename(args.cfg_file)[:-3]}_1.png")
    # print(f"saved /scratch/wz3008/SlotAttn/MetaSlot/visualize_frames/{os.path.basename(args.cfg_file)[:-3]}_1.png")
    vutils.save_image(frames2, f"/scratch/wz3008/SlotAttn/MetaSlot/visualize_frames/{os.path.basename(args.cfg_file)[:-3]}_TTT_{args.visualize_ttt}_{args.ttt_lr}_step_{args.ttt_step}.png")
    print(f"saved /scratch/wz3008/SlotAttn/MetaSlot/visualize_frames/{os.path.basename(args.cfg_file)[:-3]}_TTT_{args.visualize_ttt}_{args.ttt_lr}_step_{args.ttt_step}.png")
