...
# 3654456 / 1024 = 3569
# 100 epoch -> 356900
total_step = 400000  # 100000 better
val_interval = 1000
batch_size_t = 1024  # 64 better
...
transform_t = [
    ...
    # dict(type="RandomResizedCrop", keys=["image"], size=resolut0, scale=[0.75, 1.0],
    #      ratio=[1.0, 1.0], interp="bilinear"),
...
# before step: CBLinearCosine lr, after forward: convert output.attent to segmentation masks: (b,n,h,w) -> (b,h,w) [256x256]
# AverageLog from loss_fn and metric_fns -> log_file
callback_t = [
...
callback_v = [
    ...
    callback_t[1],  # dict(type="AverageLog", log_file=...)
    # dict(type="SaveModel", save_dir=..., since_step=val_interval),
]
